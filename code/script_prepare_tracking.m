...
if tri_objRate > 0.01
	[hist_model, fg_colorsL, fg_colorsS, bg_Colorss, fg_idx,...
 	fg_idxL, bg_idx] = gene_histSVM(sp{ff_initial}.sp_hist, mask, vid_info.ht, vid_info.wd, sp{ff_initial}, param_trackß);
end
...
[cnnModel, feats_fg, feats_bg] = gene_CNNSVM(cnnFeats, fgIdxCNN, bgIdx, opt);
